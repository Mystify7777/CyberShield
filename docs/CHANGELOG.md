...
- **Upload middleware stabilization**: Hardened upload validation with frozen MIME allowlists, magic-byte verification, a 25 MB absolute upload cap, explicit `wx` persistence writes, and visible delete-failure logging.
